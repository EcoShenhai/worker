  ...
  return (
    <>
      ...
      <div className="grid cols-2">
        <div className="card">
          <div className="card-head"><h3>Add reference (text)</h3></div>
          <div className="card-body">
            <form onSubmit={submit}>
              ...
              <div className="field"><label>Text content</label><textarea value={form.extractedText} onChange={(e) => setForm({ ...form, extractedText: e.target.value })} style={{ minHeight: 160 }} required /></div>
